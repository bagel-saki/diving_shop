...
<head>
  ...
  <!-- meta情報 -->
  <title>privacy-policy__diving_shop</title>
  <meta name="description" content="ダイビングショップのプライバシーポリシーのページです">
  <meta property="og:site_name" content="privacy-policy__diving_shop">
  <meta property="og:url" content="https://aaa.com/privacy-policy">
  <meta property="og:type" content="website">
  <meta property="og:title" content="privacy-policy__diving_shop">
  <meta property="og:description" content="ダイビングショップのプライバシーポリシーのページです">
...
<body>
  ...
  <main>
    <div class="p-lower-mv p-lower-mv--privacy">
      <div class="p-lower-mv__content">
        <h1 class="p-lower-mv_title">privacy policy</h1>
      </div>
    </div>
    <div class=" l-inner">
    ...
    <div class="l-lower-head">
      <div class="p-privacyPolicy-section">
        <div class="p-privacyPolicy-section__inner l-inner">
          <div class="p-privacyPolicy-section__content">
            <h2 class="p-privacyPolicy-section__title"> プライバシーポリシー </h2>
            <div class="p-privacyPolicy-section__text">
              ...
              <br>
              <ul>
                <li>お客様からのお問い合わせやサポートの提供 ・当社のサービスや製品の提供 ・当社のサイトの改善や新しいサービスの開発 ・法律や規制に基づく義務の履行</li>
              </ul>
              <ol>
              ...
              <br>
              <ul>
                <li>お客様の同意がある場合 ・法律や規制に基づく場合 ・当社が信頼できると判断した業務委託先に必要な範囲で提供する場合</li>
              </ul>
              <ol>
          ...
          <div class="p-privacyPolicy-section__fish">
