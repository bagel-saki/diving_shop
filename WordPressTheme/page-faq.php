...
<head>
  ...
  <!-- meta情報 -->
  <title>faq__diving_shop</title>
  <meta name="description" content="ダイビングショップのよくある質問ページです">
  <meta property="og:site_name" content="faq__diving_shop">
  <meta property="og:url" content="https://aaa.com/faq/">
  <meta property="og:type" content="website">
  <meta property="og:title" content="faq__diving_shop">
  <meta property="og:description" content="ダイビングショップのよくある質問ページです">
                ...
                <li class="p-faq-boxes__item js-accordion-item">
                  <div class="p-faq-box">
                    <div class="p-faq-box__question js-accordion-question">
                      <p class="p-faq-box__question-text">ここに質問が入ります。</p>
                    </div>
                    <div class="p-faq-box__answer js-accordion-content">
                      <p class="p-faq-box__answer-text">ここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入りますここに質問の答えが入ります</p>
                    </div>
                  </div>
                </li>
                <li class="p-faq-boxes__item js-accordion-item">
