...
<head>
  ...
  <!-- meta情報 -->
  <title>terms__diving_shop</title>
  <meta name="description" content="ダイビングショップの利用規約のページです">
  <meta property="og:site_name" content="terms__diving_shop">
  <meta property="og:url" content="https://aaa.com/terms/">
  <meta property="og:type" content="website">
  <meta property="og:title" content="terms__diving_shop">
  <meta property="og:description" content="ダイビングショップの利用規約のページです">
...
<body>
  ...
  <main>
    <div class="p-lower-mv p-lower-mv--terms">
      <div class="p-lower-mv__content">
        <h1 class="p-lower-mv_title">terms<span> of</span> service</h1>
      </div>
    </div>
    <div class=" l-inner">
    ...
    <div class="l-lower-head">
      <div class="p-terms-section">
        <div class="p-terms-section__inner l-inner">
          <div class="p-terms-section__content">
            <h2 class="p-terms-section__title"> 利用規約 </h2>
            <div class="p-terms-section__text">
              ...
              <ul>
                <li>当社のサービスに対して不正なアクセスをすること ・当社のサービスにおいて、他のユーザーに対して迷惑をかける行為をすること ・当社のサービスを商業目的で利用すること ・当社のサービスに関する知的財産権を侵害する行為をすること ・その他、法律や公序良俗に反する行為をすること </li>
              </ul>
              <br>
              <ol>
          ...
          <div class="p-terms-section__fish">
